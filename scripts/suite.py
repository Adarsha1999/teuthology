...
Scheduler arguments:
 ...
 --rerun-exact <bool>        Use exact job description matching for rerun
                              instead of substring matching. This provides
                              precise filtering by matching exact job
                              descriptions from the original run [default: false].
 --rerun-skip-known <bool>    Skip jobs with known failure patterns during rerun.
                              Only rerun jobs with unknown failures by checking
                              against known_patterns.json [default: false].
